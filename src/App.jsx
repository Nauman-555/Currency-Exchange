...
const handleClickConvert = () => {
  ...
  return (
    ...
    <div className='fan'>
      <div>
      <label htmlFor="selectBase">Select an Source:</label>
      ...
      <label htmlFor="selectOption">Select a Target:</label>
       <select id="selectOption2" value={target} onChange={handleOptionChange2}>
        <option value="">Select...</option>
        <option value="ARS">ARS</option>
        <option value="AUD">AUD</option>
        <option value="BCH">BCH</option>
      ...
      <br></br>
      <input type="number" value={amount} placeholder='  Enter amount' onChange={handleAmountChange} />
      <br />
      <button className='but' onClick={handleClickConvert}>Convert</button>
    {rate && typeof rate === 'object' && base && target && amount ? (
  <div>
    <h2> {calculateConvertedAmount()} {target} </h2>
  </div>
) : null}
